...
MOCK_PRODUCTS = [
    {'id': 1, 'name': 'MacBook Pro', 'price': 1999, 'category': 'Ноутбуки', 'owner_id': 1},
    {'id': 2, 'name': 'iPhone 15', 'price': 999, 'category': 'Смартфоны', 'owner_id': 2},
    {'id': 3, 'name': 'iPad Air', 'price': 599, 'category': 'Планшеты', 'owner_id': 1},
    {'id': 4, 'name': 'Samsung TV', 'price': 1299, 'category': 'Телевизоры', 'owner_id': 3},
]

MOCK_ORDERS = [
    {'id': 1, 'product_id': 1, 'quantity': 1, 'total': 1999, 'status': 'completed', 'owner_id': 1},
    {'id': 2, 'product_id': 2, 'quantity': 2, 'total': 1998, 'status': 'processing', 'owner_id': 2},
    {'id': 3, 'product_id': 3, 'quantity': 1, 'total': 599, 'status': 'pending', 'owner_id': 1},
]
