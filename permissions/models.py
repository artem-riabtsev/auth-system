...
class AccessRule(models.Model):
    ...
    permission_type = models.ForeignKey(PermissionType, on_delete=models.CASCADE, verbose_name='Тип разрешения')
    scope = models.CharField(max_length=10, choices=SCOPE_CHOICES, default='NONE', verbose_name='Область действия')
    created_at = models.DateTimeField(auto_now_add=True, verbose_name='Дата создания')
